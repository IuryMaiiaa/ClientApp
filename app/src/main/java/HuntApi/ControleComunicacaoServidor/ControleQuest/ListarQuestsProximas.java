...
public class ListarQuestsProximas extends AsyncTask<String, Void, List<QuestGeolocalizada>> {
    ...
    protected List<QuestGeolocalizada> doInBackground(String... strings) {
        ...
        try {
            URL url = new URL(urlServidor.getUrlQuest() + strings[0] + "/" + cordenada.getLat()+ "/"
                            + cordenada.getLon() + "/" + raio);
